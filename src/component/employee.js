  ...
  return (
    <section className="flex gap-6">
      ...
      <div class="flex flex-col items-center  px-40 py-8 mx-auto md:h-screen lg:py-0 ">
            <div class="mt-8">
                <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 text-blue-600">Employee's List</h1>
            </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    <div className="p-1.5 w-full inline-block align-middle">
                        ...
                        <div class="mt-8 flex flex-col items-center ">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={ () => navigate('/addemployee') }>Add Employee</button>
                        </div>
                    </div>
                </div>
            </div>
